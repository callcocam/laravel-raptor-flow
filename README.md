# This is my package laravel-raptor-flow
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-raptor-flow.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-raptor-flow)
...
```bash
php artisan vendor:publish --tag="laravel-raptor-flow-views"
```

## Usage

```php
$laravelRaptorFlow = new Callcocam\LaravelRaptorFlow();
echo $laravelRaptorFlow->echoPhrase('Hello, Callcocam!');
```
